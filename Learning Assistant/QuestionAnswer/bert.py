...
# model = QA("model")
# para = "Air India has received the first of two Boeing 777 aircraft, which will fly the President, Vice-President and Prime Minister on international state visits. Currently, the three premiers travel on Air India’s Boeing 747 planes, which have served for nearly 25 years. The new aircraft will have the call sign ‘Air India One’. The aircraft is equipped with high security features. President Ram Nath Kovind boarded the Air India One-B777 aircraft on Tuesday for its inaugural flight to Chennai, according to a Rashtrapati Bhavan statement." 
# question = "who boarded on the inaugural flight of Air India one?"
# print(model.predict(para, question)["answer"])
